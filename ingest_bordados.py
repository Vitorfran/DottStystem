...
try:
    ...
    print("  .\\venv\\Scripts\\python.exe ingest_bordados.py")
    sys.exit(1)
...
def main():
    print("Iniciando importação da base de conhecimento do Vitorbordados para o Chroma DB...")
    ...
    # 2. Processa o arquivo Markdown de bordados
    markdown_file = "bordados_knowledge.md"
    ...
    # 4. Obtém ou cria a coleção 'bordados' (mapeada no Langflow como lf_0d53df69a9c4a414)
    collection_name = "lf_0d53df69a9c4a414"
    ...
    print("\n✓ Sucesso! A base de conhecimento de bordados foi indexada e inserida na coleção 'bordados'.")
    print(f"Total de documentos ativos na coleção 'bordados': {collection.count()}")
